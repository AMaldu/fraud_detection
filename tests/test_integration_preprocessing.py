...
class TestFullPipeline(unittest.TestCase):
    ...
    def test_full_pipeline(self):
        ...
        self.assertTrue(os.path.exists(os.path.join(self.save_dir, 'X_train_scaled.npz')))
        self.assertTrue(os.path.exists(os.path.join(self.save_dir, 'X_test_scaled.npz')))
